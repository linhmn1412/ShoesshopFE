...
const AddToCart = ({data, variants}) => {
  ...
  const handleColorClick = (color) => {
    ...
    if (!variants.find((variant) => variant.color === color && variant.size === selectedSize)) {
      setSelectedSize("");
    }
  };
    ...
    return ( 
      ...
      <div className="row align-items-center mb-4">
        ...
        <button
          ...
          ${selectedColor === color ? "btn btn-outline-primary" : "btn btn-link border border-1 primary-text"}`}
        ...
        <button
          key={index}
          className={` fs-6  mx-1 text-capitalize 
          ${selectedSize === size ? "btn btn-outline-primary" : "btn btn-link border border-1 primary-text"}`}
        ...
        <div className="row align-items-center mb-4">
          ...
          <div className="col-9 d-flex align-items-center">
            <InputQuantity id= {data.id_shoe} max = {quantityStock} value = {selectedQuantity} onChangeInput ={handleQuantityChange} />
            &ensp;
