      ...
      <div className="modal-dialog modal-dialog-scrollable" role="document">
        <div className="modal-content h-100">
          ...
          <div className="modal-body">
            <p>
              Mã đơn hàng:&ensp;
              <span className="primary-text fw-bold">{order.id_order}</span>
            </p>
            <p>
              Khách hàng:&ensp;
              <span className="primary-text fw-bold">{order.name_buyer}</span>
            </p>
            <p>
              Số điện thoại:&ensp;
              <span className="primary-text fw-bold">{order.phone_number}</span>
            </p>
            <p>
              Địa chỉ:&ensp;
              <span className="primary-text fw-bold">{order.address}</span>
            </p>
            <p>
              Ngày đặt hàng:&ensp;
            ...
            <p>
              Ghi chú:&ensp;
              <span className="primary-text fw-bold"> {order.note}</span>
            </p>
            <p>
              Tổng tiền:&ensp;
              <span className="primary-text fw-bold">
                {formatMoney(parseInt(order.total) + 20000)}
              </span>
            </p>
